        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
             32/874 A8, Pallichambayil Rd, Chakkalakkal, Palarivattom, Kochi, Kerala 682025
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300">32/874 A8, Pallichambayil Rd, Chakkalakkal, Palarivattom, Kochi, Kerala 682025</p>
                  {/* <p className="text-gray-300">Bangalore, Karnataka 560100</p> */}
                </div>
              </div>
